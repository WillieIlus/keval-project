    ...
    <UModal v-model:open="deleteModalOpen">
      <template #content>
        <div class="p-6 text-center">
          ...
          <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Delete Core Value?</h3>
          <p class="text-gray-600 dark:text-gray-300 mb-6">This will remove "{{ deletingItem?.title }}" from your values.</p>
